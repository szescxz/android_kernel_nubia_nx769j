...
#define AW8692X_BIT_SYSCTRL4_GAIN_MODE_MASK_LN		(~(1<<0))
#define AW8692X_BIT_SYSCTRL4_GAIN_ENABLE_LN		(1<<0)
...
#define AW8692X_BIT_ANACFG13_BST_PEAKCUR_3A		(6<<4)
#define AW8692X_BIT_ANACFG13_BST_PEAKCUR_3P75A		(9<<4)
