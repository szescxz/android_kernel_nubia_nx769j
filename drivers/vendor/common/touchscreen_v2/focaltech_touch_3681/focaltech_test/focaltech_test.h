...
#define FTS_SAVE_FILE_PATH                     "/mnt/sdcard/"
...
#define MAX_SAVE_FILE_NAME_LEN 50
#define MAX_SAVE_PATH_NAME_LEN  20
...
#define FTS_TEST_FUNC_EXIT()  pr_info("[FTS_TS][TEST]%s: Exit(%d)\n", __func__, __LINE__)

#define FTS_TEST_INFO(fmt, args...) pr_info("[FTS_TS/I][TEST]%s:"fmt"\n", __func__, ##args)
