...
#if IS_ENABLED(CONFIG_PM)
#if !IS_ENABLED(CONFIG_FB) && !IS_ENABLED(CONFIG_HAS_EARLYSUSPEND) && !IS_ENABLED(CONFIG_TOUCHSCREEN_DRM_PANEL_NOTIFIER)
/**
...
static int goodix_ts_pm_suspend(struct device *dev)
{
	...
	ts_info("success in the goodix_ts_suspend two");
