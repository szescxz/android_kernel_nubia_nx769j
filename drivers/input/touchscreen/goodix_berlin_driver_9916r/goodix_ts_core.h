...
#include "firmware_config/tiga/goodix_config.h"
...
struct goodix_ts_hw_ops {
	...
	int (*read)(struct goodix_ts_core *cd, unsigned int addr, unsigned char *data, unsigned int len);
	int (*write)(struct goodix_ts_core *cd, unsigned int addr, unsigned char *data, unsigned int len);
	int (*read_flash)(struct goodix_ts_core *cd, unsigned int addr, unsigned char *data, unsigned int len);
	...
	int (*set_rotation_limit_level)(struct goodix_ts_core *cd, int mrotation);
